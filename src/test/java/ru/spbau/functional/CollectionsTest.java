...
public class CollectionsTest {
    ...
    @Test
    public void testMap() {
        List<Boolean> checkEven = new ArrayList<>();
        List<Boolean> checkOdd  = new ArrayList<>();
        List<Boolean> checkType = new ArrayList<>();
    ...
    public void testFilter() {
        List<Integer> checkEven = new ArrayList<>();
        List<Integer> checkOdd = new ArrayList<>();
        List<Chelsea> checkType = new ArrayList<>();
    ...
    public void testFoldl() {
        ...
        Function2<Integer, Integer, Integer> plus  = (arg1, arg2) -> arg1 + arg2;

        List<Integer> integerList = Arrays.asList(7, 5, 3, -1);
